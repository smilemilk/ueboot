    ...
    <div class="dbTreeScroll" style="padding-top: 10px">
        <div class="dbTree jstree-default jstree-checkbox-selection">
            <ul class="jstree-container-ul jstree-children jstree-wholerow-ul jstree-no-dots">
                <db-tree-node :tree="treeNode" :showCheckbox="showCheckbox" v-on:itemClick="listenerItemClick"
                              :parentNode="parentNode"></db-tree-node>
            </ul>
        </div>
    </div>
</template>
...
<script type="text/jsx">
    import DbTreeNode from "./DbTreeNode.vue";
    export default {
        name: 'DbTree',
        componentName: 'DbTree',
        props: {
            showCheckbox: {
                type: Boolean,
                default: false
